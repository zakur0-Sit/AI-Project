from .CourseEntry import TimeInterval, Teacher, CourseType, Course, StudentGroup, Classroom, CourseEntry
...
class SoftConstraints:
    ...
    def add_teacher_for_course(self, teacher: Teacher, course: Course, course_type: CourseType):
    ...
    def add_optional_course_types(self, course: Course, course_types: list[CourseType]):
